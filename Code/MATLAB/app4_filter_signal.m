...
fft_x_filter = fft(filtered_data(:, 1, 1)); % Perform Fourier transform on the filtered signal
...
plot(filtered_data(:, 1, 1), 'r', 'linewidth', 0.5); xlim([0, length(filtered_data(:, 1, 1))])
